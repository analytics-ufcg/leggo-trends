...
create_graphic_comparativo <- function(data, titulo) {
...
p <- create_graphic_comparativo(semana_comp, "Comparação da evolução da pressão - PEC: Apelido vs Nome formal")
...
p <- create_graphic_comparativo(semana_comp, "Comparação da evolução da pressão - MPV: Apelido vs Nome formal")
